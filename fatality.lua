...
local Window = Library:CreateWindow({
    ...
    LoadingSubtitle = "By s1mple",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "fatalityCB", -- Create a custom folder for your hub/game
        FileName = "fatalityCB"
    },
    Discord = {
        Enabled = true,
        Invite = "grnMJQ5WZH", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
        ...
        Note = "discord.gg/f3t4XH2GtP",
        FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
        SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
        GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
        Key = {"fatality-93545647360"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
